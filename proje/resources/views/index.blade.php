...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/sado.css') }}">
</head>
<body>
...
<section id="hero" class="hero-section text-center d-flex align-items-center justify-content-center">
    <div class="hero-content">
        ...
        <a class="btn btn-primary mt-4" href="{{url('login/facebook')}}">Login with Facebook</a>
    </div>
...
<footer class="bg-dark text-white text-center py-3">
    <p>&copy; {{date('Y')}} Instagram Feed App. All rights reserved.</p>
</footer>
