                   ...
                   <figcaption>
                      ...
                      <p class="instagram-account__token-status">
                         ...
                         <span class="badge badge--success ">
                            <img class="icon badge__icon" src="{{ asset('app/icons/success.svg') }}" alt="Active">
                            Active
                         </span>
                      </p>
             ...
             <tbody>
                ...
                <tr>
                   ...
                   <td data-caption="Business Facebook: ">
                      <span class="badge badge--success ">
                        <img class="icon badge__icon" src="{{ asset('app/icons/success.svg') }}" alt="Available">
                         Available
                      </span>
                   </td>
                   ...
                   <td data-caption="Consumer: ">
                      <span class="badge badge--danger ">
                         <img class="icon badge__icon" src="{{ asset('app/icons/not.svg') }}" alt="Not Available">
                         Not available
                      </span>
                   </td>
                </tr>
