...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="{{ asset('app/css/sado_app.css') }}">
      @livewireStyles
   </head>
      ...
      <header class="main-header main-header--vertical">
         ...
         <nav data-menu="" class="nav" data-popover="" data-popover-enabled="">
            ...
            <ul class="nav__list nav__list--vertical" data-popover-content="">
               <li class="nav__item">
                  <a class="nav__link nav__link--active nav__link--with-background" href="{{ url('dashboard') }}" aria-label="Dashboard">
                  <img class="icon icon--extra-large" src="{{ asset('app/icons/dashboard.svg') }}" alt="">
                  <span class="nav__link-text">Dashboard</span>
                  </a>
               </li>
               <li class="nav__item">
                  <a class="nav__link" href="{{ url('instagram-accounts') }}" aria-label="Accounts">
                  <img class="icon icon--extra-large" src="{{ asset('app/icons/accounts.svg') }}" alt="">
                  <span class="nav__link-text">Accounts</span>
                  </a>
               </li>
               <li class="nav__item">
                  <a class="nav__link" href="{{ url('my-widgets') }}" aria-label="Widgets">
                    <img class="icon icon--extra-large" src="{{ asset('app/icons/widget.svg') }}" alt="">
                     <span class="nav__link-text">Widgets</span>
                  </a>
               </li>
               <li class="nav__item">
                  <a class="nav__link" href="{{ url('settings') }}" aria-label="Settings">
                    <img class="icon icon--extra-large" src="{{ asset('app/icons/settings.svg') }}" alt="">
                     <span class="nav__link-text">Settings</span>
                  </a>
               </li>
               <li class="nav__item">
                  <a class="nav__link" href="{{ url('logout') }}" aria-label="Log out">
                    <img class="icon icon--extra-large" src="{{ asset('app/icons/logout.svg') }}" alt="">
